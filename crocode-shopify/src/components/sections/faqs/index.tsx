  ...
  return (
    <Section className={styles.section}>
      <div className={styles.section__inner}>
        <Text className={styles.section__title} tag='h1' text='FAQs | Crocode' style='small'/>
        <Text className={styles.section__subtitle} tag='p' text='Find answers to common questions about our Crocode Shopify development agency and our services.' style='big'/>
